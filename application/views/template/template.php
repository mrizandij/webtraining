                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item" href=" <?= base_url(); ?>karyawan">
                                        Data Karyawan
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-toggle="dropdown">
                            <span class="avatar avatar-sm"
                                style="background-image: url(<?= base_url() ?>assets/static/avatars/default.png)"></span>
                            <div class="d-none d-xl-block pl-2">
                                <div> <?= $this->session->userdata('nama_lengkap'); ?></div>
                                <div class="mt-1 small text-muted"> <?= $this->session->userdata('level'); ?></div>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
