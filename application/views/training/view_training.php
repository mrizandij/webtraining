...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <a href="<?= base_url(); ?>training/inputtraining" class="btn btn-success mb-3">
                ...
                <table class="table table-striped table-bordered text-center">
                    ...
                    <tbody>
                        ...
                        <!-- <td> -->
                        <!-- <a href="#" data-nokaryawan="<?= $k->no; ?>" class="btn btn-sm btn-succes text-center">
                                    detail
                                </a> -->
                        <!-- <a href="#" data-nokaryawan="<?= $k->no; ?>"
                                    class="btn btn-sm btn-primary edit text-center">
                                    edit
                                </a>
                                <a href="#" data-href="<?= base_url(); ?>karyawan/hapuskaryawan/<?= $k->no; ?>"
...
<div class="modal modal-blur fade" id="modalhapuskaryawan" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    $(function() {
        ...
        $(".edit").click(function() {
            var kodekaryawan = $(this).attr("data-nokaryawan");
