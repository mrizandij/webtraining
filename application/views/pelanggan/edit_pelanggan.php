<form action="<?= base_url('pelanggan/updatepelanggan'); ?>" method="post" class="formPelanggan">
    <div class="mb-3 form-group">
        <input type="text" value="<?= $pelanggan['kode_pelanggan']; ?>" class="form-control" name="kodepelanggan"
            placeholder="Kode Pelanggan">
    </div>
    <div class="mb-3 form-group">
        <input type="text" value="<?= $pelanggan['nama_pelanggan']; ?>" class="form-control" name="namapelanggan"
            placeholder="Nama Pelanggan">
    </div>
    <div class="mb-3 form-group">
        <input type="text" value="<?= $pelanggan['alamat_pelanggan']; ?>" class="form-control" name="alamatpelanggan"
            placeholder="Alamat Pelanggan">
    </div>
    <div class="mb-3 form-group">
        <input type="text" value="<?= $pelanggan['no_hp']; ?>" class="form-control" name="nohp" placeholder="No hp">
    </div>
    <div class="mb-3 form-group">
        <select name="cabang" class="form-select">
            <option value=""> Pilih Cabang</option>
            <?php foreach ($cabang as $c) { ?>
            <option <?php if ($pelanggan['kode_cabang'] == $c->kode_cabang) echo "selected"; ?>
                value="<?= $c->kode_cabang ?>">
                <?= $c->nama_cabang; ?>
            </option>
            <?php } ?>
